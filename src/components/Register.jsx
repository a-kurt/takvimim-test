          ...
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex justify-between">
                <Link to="/">
                  <button
                    className="border-2 border-blue-500 flex items-center text-blue-500 bg-white hover:text-white hover:bg-blue-600 focus:outline-none font-medium rounded-sm text-sm px-3 py-3 text-center"
                  >
                    <BiChevronLeft size={26} />
                    <span className="mr-2">Geri Dön</span>
                  </button>
                </Link>
                  ...
                  <button
                    ...
                    type="submit"
                    className="border-2 border-blue-500 flex items-center text-white bg-blue-500 hover:bg-blue-600 focus:outline-none font-medium rounded-sm text-sm px-3 py-3 text-center"
                  >
